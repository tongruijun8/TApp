 ...
 */
public class TFilterModule_3_2 implements TLinearLayout.TLLOnClickListenter {
    ...
    public TFilterModule_3_2(Context context, View view) {
    ...
    public void setFilterTitles(String filterTitle1, String filterTitle2, String filterTitle3){
    ...
    private boolean oneShow,twoShow,threeShow;
    private List<String> list1;
    private List<String> list2 ;
    private List<String> list3 ;

    public void setSskDataList(List<String> list1, List<String> list2, List<String> list3){
        this.list1 = list1;
        this.list2 = list2;
        this.list3 = list3;
        isShowList();
