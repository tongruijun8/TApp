 ...
 */
public class TFilterTwoModule implements TLinearLayout.TLLOnClickListenter {
    ...
    public TFilterTwoModule(Context context, View view) {
...
//        viewHolder.mLayoutFilterImg1.setImageResource(R.mipmap.icon_xiala);
    ...
    private void initSSKState2(int position,boolean showSsk){
        if (position == 1) {
            if(!showSsk){
                viewHolder.mLayoutFilterImg1.setImageResource(R.mipmap.icon_shouqi);
                hideSsk();
    ...
    class ViewHolder {
        ...
        ViewHolder(View view) {
            ...
            mLayoutFilterName1.setTextColor(context.getResources().getColor(R.color.color_zhuse));
            mLayoutFilterName2.setTextColor(context.getResources().getColor(R.color.color_zhuse));
        }
    }
}
